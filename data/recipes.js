...
export const recipes = [
    ...
    },
    {
      ...
      ingredients: [
        ...
        { name: '175g de mantequilla', image: require('../assets/images/placeholder.jpg') },
        { name: '1 vaso de leche', image: require('../assets/images/placeholder.jpg') },
        { name: '100g de azúcar moreno', image: require('../assets/images/placeholder.jpg') },
    ...
    },
    {
      ...
      ingredients: [
        { name: '300g de queso crema', image: require('../assets/images/placeholder.jpg') },
        { name: '90g de azúcar', image: require('../assets/images/placeholder.jpg') },
        { name: '2 huevos', image: require('../assets/images/placeholder.jpg') },
        { name: '150ml de nata (crema para batir)', image: require('../assets/images/placeholder.jpg') },
    ...
    },
    {
      ...
      ingredients: [
        ...
        { name: '125g de azúcar', image: require('../assets/images/placeholder.jpg') },
        { name: '1 sobre de azúcar avainillada (aprox. 8g)', image: require('../assets/images/placeholder.jpg') },
        { name: '75g de harina de trigo', image: require('../assets/images/placeholder.jpg') },
        { name: '50g de harina de maíz (maicena)', image: require('../assets/images/placeholder.jpg') },
        { name: '½ sobre de levadura química (polvo de hornear, aprox. 7g)', image: require('../assets/images/placeholder.jpg') },
    ...
    },
    {
      ...
      ingredients: [
        { name: '150g de zanahoria rallada', image: require('../assets/images/placeholder.jpg') },
        ...
        { name: '90g de azúcar moreno', image: require('../assets/images/placeholder.jpg') },
        { name: '45g de harina de trigo', image: require('../assets/images/placeholder.jpg') },
        { name: '1 cucharadita de levadura química (polvo de hornear)', image: require('../assets/images/placeholder.jpg') },
        { name: '100g de almendra molida', image: require('../assets/images/placeholder.jpg') },
        { name: '60g de avellana molida', image: require('../assets/images/placeholder.jpg') },
        { name: '30g de pistacho molido', image: require('../assets/images/placeholder.jpg') },
